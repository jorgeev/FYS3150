...
NSP = np.array([2, 40, 60, 80, 100])

for sp in NSP:
    name = "Lattice_" + str(sp)
    c0 = time.time()
    ...
    Energy, S_Heat, Magnetization, Susceptibility, lMagnetizationl, Ev, Mv = nl(Energy, S_Heat, Magnetization, Susceptibility, lMagnetizationl, Ev, Mv, Temps, sp, cycls, steps)
