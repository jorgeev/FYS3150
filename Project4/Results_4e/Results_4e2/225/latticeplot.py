...
plt.grid(True)
plt.savefig("42eEnergy"+".eps", format='eps')
#plt.show()
...
plt.legend(loc='best',prop={'size': 20})
plt.grid(True)
plt.savefig("42eMagnetization"+".eps", format='eps')
#plt.show()
...
plt.legend(loc='best',prop={'size': 20})
plt.grid(True)
plt.savefig("42eHeat_Capacity"+".eps", format='eps')
#plt.show()
...
plt.legend(loc='best',prop={'size': 20})
plt.grid(True)
plt.savefig("42eSusceptibility"+".eps", format='eps')
#plt.show()
